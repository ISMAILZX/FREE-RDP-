...
await conn.send2ButtonImg(m.chat, text.trim(), `./cewe/${pickRandom(['a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q'])}.jpg`, `© Ismail Kurama | Made Whit @${owner[0]}`, 'Donasi', '.ds', 'Script Bot', '.sc', { quoted: fvideo, sendEphemeral: true, contextInfo: { mentionedJid: conn.parseMention(text), forwardingScore: 135,                 isForwarded: true ,"externalAdReply": {
          ...
          "mediaUrl": `${pickRandom(['https://instagram.com/Ismail_Kurama','https://instagram.com/Ismail832.id','https://youtube.com/IsmailKurama','https://wa.me/6283805279906?text=Sv+bang'])}`,
     //     "thumbnail": "https://i.ibb.co/ysTv8wY/Screenshot-20210808-112316.png",
         "sourceUrl": `${pickRandom(['https://instagram.com/Ismail_Kurama','https://instagram.com/Ismail832.id','https://youtube.com/IsmailKurama','https://wa.me/6283805279906?text=Sv+bang'])}`,
           }}})
/* await conn.send2ButtonImg(m.chat, text.trim(), './src/hehe.jpg', '© ISML', 'Donasi', '.ds', 'Script Bot', '.sc', 'conversation', { sendEphemeral: true, quoted: fvideo, contextInfo : { mentionedJid: conn.parseMention(text), forwardingScore: 135,
